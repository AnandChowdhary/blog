...
This is the fifth and final chapter in my five-year retrospective. After [building the first AI SDR](/blog/2025/building-the-first-as-sdr) and fighting Gmail's spam filters to reach $20k MRR, we stripped away all our email infrastructure in defeat - and discovered something unexpected in the wreckage. This is the story of how we found the real product, why it still wasn't enough, and how we made the hardest decision of all.

## Finding the real product

July 2024. We'd just announced we were killing our email deliverability tooling. No more domain buying. No more mailbox warming. No more fighting Google's spam filters. It felt like surrender.

But as we stripped away the infrastructure layer by layer, something interesting emerged from underneath all that complexity: the Brain.

The AI reasoning engine we'd built to decide when to follow up, how to classify responses, and when to escalate to humans - that was actually good. Really good. It could understand context, maintain conversation history, and make decisions that felt almost human. The email delivery was a nightmare, but the intelligence layer underneath? Solid.

I remember the exact moment it clicked. We were on a customer call, apologizing yet again for mailbox issues, when the customer interrupted us: "I don't care about the emails. I care that your AI knows when to follow up, when to give up, when to reschedule, and when to loop in my manager. It's like having a sales ops person who never sleeps."

Carlo and I looked at each other on Zoom. We'd spent two years fighting email infrastructure when our actual innovation was hiding in plain sight.
...
The wild part? We'd built it almost by accident. It started as a simple classifier to decide if replies were positive, negative, or needed human intervention. But over two years of prompt engineering, edge case handling, and customer feedback, it had evolved into something much more sophisticated. It could understand deal progression, identify buying signals, manage complex multi-threaded conversations, and even know when to shut up (harder than it sounds for AI).
