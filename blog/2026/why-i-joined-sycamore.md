...
On Halloween last year, my cofounder Carlo and I had a handshake deal with a pretty known AI company to sell FirstQuadrant, and for the first time in nearly a decade, I had nothing to build. I wrote about this in my [Year of Discovery](/blog/2025/year-of-discovery) post: the plan was to sit with the discomfort. Not rush into the next thing, and figure out who I am when I'm not "cofounder of X". As you'd expect, that lasted about six weeks.
...
Today, [Sycamore](https://sycamore.so) comes out of stealth.

[We raised $65 million](https://sycamore.so/press-releases/sycamore-raises-65m-seed/) with Coatue and Lightspeed co-leading. We're working with Fortune 500 companies. And the problem we're solving, giving enterprises a trusted way to build, deploy, and orchestrate AI agents, is one of those problems that only gets bigger the more you look at it.
