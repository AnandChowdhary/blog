...
Today, I'm proud to launch [**Uppload v2**](/projects/open-source/uppload/), a rewrite from the ground up in TypeScript, with support for over 30 a-la-carte plugins, keeping the same powerful API, easy-to-use interface, and browser support.
